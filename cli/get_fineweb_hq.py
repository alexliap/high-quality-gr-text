...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Download FineWeb2-HQ dataset using Polars")
    ...
    output_path = Path(f"data/fineweb_hq/gr/{args.w}")
    ...
    for idx, url in enumerate(urls, 1):
        ...
        try:
            ...
            single_lf = single_lf.select([
                "text", "url", "file_path",
                pl.col("language").str.slice(0, 2).alias("language"),  # ell -> el
            ])
    ...
    logger.info("Finished downloading Greek data from Fineweb HQ.")
