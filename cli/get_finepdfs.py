...
def process_language(repo_id: str, language_path: str, output_dir: str, output_format: str, hf_token: str = None):
    ...
    logger.info(f"Finished processing {language_path}.")


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Download FinepdfsEdu dataset using Polars")
    ...
    process_language(
        repo_id=repo_id,
        language_path="data/ell_Grek",
        output_dir=f"data/finepdfs_edu/gr/{args.w}",
